...
ACTION_POLICIES: dict[str, ActionPolicy] = {
    ...
    "soar_delegate": ActionPolicy(0, 100, 80, severity=1),
    "require_mfa": ActionPolicy(35, 100, 85, severity=1),
    "revoke_session": ActionPolicy(45, 100, 82, severity=2, disruptive=True),
    "degrade_privileges": ActionPolicy(55, 100, 78, severity=2, disruptive=True),
    "crypto_rotate": ActionPolicy(55, 100, 75, severity=2, disruptive=True),
    "require_release_approval": ActionPolicy(35, 100, 88, severity=1),
    "revoke_pipeline_token": ActionPolicy(55, 100, 80, severity=2, disruptive=True),
    "quarantine_artifact": ActionPolicy(65, 100, 78, severity=2, disruptive=True),
    "block_deployment": ActionPolicy(70, 100, 76, severity=3, disruptive=True),
    "endpoint_isolate": ActionPolicy(50, 100, 80, severity=2, disruptive=True),
